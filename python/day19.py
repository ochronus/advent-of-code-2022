...
lines = open("../input/day19.txt").readlines()
...
def bfs(costs, robots, num_minutes, top_queue=30000):
    ...
    while queue:
        ...
        for i in range(4):
            ...
            if all(
                [old_inventory[j] >= cost_robot[j] for j in range(4)]
            ):  # We can build a robot!!
                ...
                queue.append(
                    (minutes + 1, (new_robots, new_inventory_state, new_mined))
                )
