...
# Part 1 is simple iterating over cubes' neighbors and adding up cubes not occupied.

# In part 2, we need to find out which trapped regions and exclude those from the part 1's result.
